...
|---|---|---|---|
| Management API | `api` | PHP 8.3+ | Laravel 12, PHP-FPM, Sanctum, Spatie Permission, Eloquent ORM |
...
| Plagiarism Check | `plagiarism-checker` | Go 1.22+ | sqlx + pgx, slog, Dolos CLI |
